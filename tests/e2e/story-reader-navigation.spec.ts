...
/**
 * Fills the anonymous request form (age 6 → band 5-7, courage theme) and
 * submits, like the T023 journey. Runs against the production build whose
...
/**
 * Scene-by-scene keyboard journey (T036).
 *
 * Generates a story with the fictional default provider, then drives the
 * reader with the keyboard alone: bounds at first/middle/last scene,
