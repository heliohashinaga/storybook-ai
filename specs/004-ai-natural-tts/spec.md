...
- **FR-011**: A qualidade/naturalidade do TTS DEVE ser **configurável** via `OPENROUTER_TTS_MODEL` (perfil custo-vs-naturalidade: custo-eficiente ou premium), escolhendo o modelo por ambiente — sem knob de custo por narração (não há teto de custo por env).
