...
- **FR-005**: System MUST select vocabulary, tone, and sentence complexity appropriate to the selected age band (2–4, 5–7, or 8–9).
...
- **Age range (resolved via clarify, Option A)**: The target range is **2–9 years**, divided into **three age bands**: **2–4**, **5–7**, and **8–9**. Content (vocabulary, sentence length, plot complexity, theme treatment) is calibrated per band as the basis for age-appropriateness.
